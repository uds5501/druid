...
{
  private static final String DRUID_ROUTER_TEMPLATE = "/data/manifests/druid-components/router.yaml";
  ...
  {
    return "druid.service=druid/router\n" +
