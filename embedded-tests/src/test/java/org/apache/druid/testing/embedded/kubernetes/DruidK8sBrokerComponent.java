...
{
  private static final String DRUID_BROKER_TEMPLATE = "/data/manifests/druid-components/broker.yaml";
  ...
  {
    return "druid.service=druid/broker\n" +
